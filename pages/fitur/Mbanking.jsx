    ...
    <>
      ...
      <div className="bg-white">
        ...
        <div className="flex flex-col-reverse mx-6 md:grid md:grid-cols-2 md:justify-items-center md:mx-32">
          {/* Col 1 */}
          <div>
            <div className="text-[#1E1E1E] text-lg text-justify break-words my-10 font-medium md:text-2xl md:mb-14 md:mt-2">
              {fitur[2].subtitle}
            </div>
          ...
          {/* Col 2 */}
          <div>
            <img src={fitur[2].image} alt="Credit Score" className="w-auto justify-center lg:w-auto md:justify-items-center" />
          </div>
        </div>
      </div>
      <Subs />
