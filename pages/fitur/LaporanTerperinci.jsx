    ...
    <>
      ...
      <div className="bg-white">
        ...
        <div className="flex flex-col-reverse mx-6 md:grid md:grid-cols-2 md:justify-items-center md:mx-32">
          {/* Col 1 */}
          <div>
            <div className="text-[#1E1E1E] text-lg text-justify break-words my-10 font-medium md:text-2xl md:mb-14 md:mt-3">
              {fitur[3].subtitle}
            </div>

            <div className="text-[#5C6978] mb-32 md:mb-56">
              {fitur[3].content.map((val, index) => {
                return (
          ...
          {/* Col 2 */}
          <div>
            <img src={fitur[3].image} alt="Credit Score" className="w-auto justify-center lg:w-auto md:justify-items-center" />
          </div>
        </div>
      </div>
      <Subs />
