export const testimoni = [
  {
    ...
    job: "Pekerja Lepas",
    review:
      "Ini adalah fenomenal, pembayaran yang terintegerasi, sistem pembelian pulsa dan PPOB yang lengkap",
    star: 5,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    job: "Pekerja Lepas",
    review:
      "Semua telah terdigitalisasi dan cashless saya sangat suka itu semoga dimasa depan lebih simple lagi",
    star: 3,
  },
];
...
export const fitur = [
  ...
  },
  {
    ...
    subtitle:
      "Cek saldo rekening, transfer dana, dan bayar tagihan Anda dengan lebih mudah dan nyaman melalui M-Banking CREDIS.",
    content: [
      "Proses pembuatan rekening secara online",
      "Tidak ada saldo minimum",
      "Gratis biaya admin bulanan",
      "Tampilan aplikasi ringan & mudah digunakan",
    ],
  },
  {
    id: 4,
    ...
    subtitle:
      "Semua riwayat transfer, mutasi, dan sistem keuangan Anda direkap secara terperinci dan bisa di unduh.",
    content: [
      "Cek mutasi mingguan atau bulanan",
      "Cek riwayat detail transfer",
      "Cek riwayat detail kredit",
      "Dapat di unduh dalam format PDF",
    ],
  },
];
...
export const faqCreditScoring = [
  {
    id: 1,
    title: "Bagaimana Saya Bisa Melihat Laporan Kredit Saya?",
    subtitle:
      "Anda dapat melihat laporan kredit Anda melalui fitur Laporan Terperinci. Jika Anda ingin melihat laporan kredit Anda dari agen pelaporan kredit lainnya, Anda dapat meminta salinan laporan kredit Anda secara gratis dengan menghubungi kami melalui email supportcredis@credis.id",
  },
  {
    id: 2,
    title:
      "Bagaimana Credis Mempertimbangkan Saya Untuk Mendapat Penawaran Kartu Kredit?",
    subtitle:
      "Untuk melakukan registrasi awal, Anda perlu mempersiapkan e-KTP asli dan NPWP jika punya. Saat melanjutkan ke tahap aktivasi video call, Anda hanya perlu mempersiapkan e-KTP asli, lalu ikuti petunjuk dari Tim Support Credis.",
  },
  {
    id: 3,
    title: "Berapa Nilai Kredit Tertinggi?",
    subtitle:
      "Tidak ada! Anda tidak perlu melakukan deposit dalam jumlah berapapun saat melakukan registrasi akun Credis.",
  },
  {
    id: 4,
    title: "Berapa Nilai Kredit Skor Yang Dianggap Baik?",
    subtitle:
      "Skor kredit antara 661 dan 780 dianggap baik. Apa pun di bawah itu dianggap buruk, sementara apa pun di atas itu dianggap sangat baik.",
  },
  {
    id: 5,
    title: "Haruskah saya membayar apa pun untuk memeriksa skor kredit saya?",
    subtitle:
      "Tidak. Jika anda termasuk partner kami, Anda dapat memeriksa skor kredit dan laporan kredit Anda secara gratis.",
  },
];

export const faqMobileBanking = [
  {
    id: 1,
    title: "Syarat Utama Menjadi Nasabah Credis",
    subtitle:
      "Anda adalah Warga Negara Indonesia yang sudah memiliki e-KTP dan menggunakan smartphone.",
  },
  {
    id: 2,
  ...
  {
    id: 3,
    title: "Minimal Saldo Saat Buat Akun",
    subtitle:
      "Tidak ada! Anda tidak perlu melakukan deposit dalam jumlah berapapun saat melakukan registrasi akun Credis.",
  },
  {
    id: 4,
    title: "Spesifikasi Smartphone Yang Harus Dimiliki",
    subtitle:
      "Untuk menggunakan M-Banking Credis, persyaratan minimumnya adalah Android 6.0 dan iOS 13.0.",
  },
  {
    id: 5,
    title: "Berapa Akun M-Banking Credis yang Bisa Dimiliki?",
    subtitle:
      "Anda hanya dapat memiliki satu akun Credis per e-KTP yang dimiliki. Namun, di akun Credis Anda dapat membuat banyak 'Kantong' untuk berbagai kebutuhan yang berbeda. Setiap 'Kantong' akan memiliki nomor rekening sendiri, yang nantinya memudahkan Anda mengatur keuangan.",
  },
];

export const faqVerifikasiKyc = [
  {
    id: 1,
    title: "Apa saja data yang harus saya isi?",
    subtitle:
      "Kamu harus mengisi No KTP, Nama Lengkap, Tempat Lahir, Alamat, Foto KTP dan Swafoto (selfie) dengan KTP. Tanggal lahir dan jenis kelamin akan otomatis terisi berdasarkan Nomor e-KTP kamu.",
  },
  {
    id: 2,
    title:
      "Berapa lama waktu yang dibutuhkan untuk melakukan proses verifikasi?",
    subtitle:
      "Proses verifikasi maksimal 3x24 jam, baik untuk pengajuan baru maupun untuk pengajuan ulang (perbaikan dan pembaharuan data).",
  },
  {
    id: 3,
    title: "Kenapa info pribadi saya ditolak?",
    subtitle:
      "Ada beberapa alasan verifikasi data pribadi kamu ditolak, diantaranya seperti Foto KTP kamu tidak jelas (blur) atau bukan foto KTP sama sekali, Foto swafoto (selfie) dengan KTP kamu tidak jelas (blur) atau bukan foto selfie dengan KTP sama sekali, Foto KTP tidak sama dengan foto selfie, dan Data yang kamu masukan tidak sama dengan data di KTP.",
  },
  {
    id: 4,
    title: "Bisakah saya menggunakan identitas selain KTP?",
    subtitle:
      "Tidak, sesuai perundang-undangan yang berlaku verifikasi data pribadi hanya bisa dilakukan dengan e-KTP.",
  },
  {
    id: 5,
    title: "Apakah Credis menjamin keamanan data pribadi saya?",
    subtitle:
      "Ya, Credis menjamin keamanan data pribadi kamu dan tidak akan menggunakannya tanpa seizin pemilik data. Silakan baca Syarat dan Ketentuan untuk penjelasan lebih lanjut.",
  },
];

export const faqLaporanTerperinci = [
  {
    id: 1,
    title: "Di mana saya mendapatkan salinan laporan keuangan atau faktur?",
    subtitle:
      "Harap masuk ke menu lapporan karena laporan keuangan dan faktur disimpan ke menu tersebut dan akan terhapus otomatis setiap 6 bulan sekali maka dari itu download jika anda ingin menyimpannya dalam waktu yang lebih lama anda akan mendapatkan file berekstensi pdf. Jika dokumen tidak dapat ditemukan, harap hubungi Customer Service kami karena mereka dapat mengirimkan salinannya melalui email kepada Anda.",
  },
  {
    id: 2,
    title:
      "Berapa lama saya akan mendapat laporan keuangan jika saya tidak dapat menemukannya?",
    subtitle:
      "Laporan akan dikirimkan selambat-lambatnya 7x24 jam. Tim kami akan menyiapkan laporan anda sampai dengan transaksi terakhir anda di hari laporan dikirimkan kepada anda.",
  },
  {
    id: 3,
    title:
      "Mengapa saya mendapatkan kesalahan saat mencoba melihat atau menyimpan laporan?",
    subtitle:
      "Anda perlu menginstal Acrobat Reader 9.x/higher pada mesin Anda untuk melihat laporan keuangan. Pengaturan untuk Acrobat Reader mungkin tidak diinstal dengan benar sebelum meminta laporan keuangan harap verifikasi Persyaratan Sistem. Acrobat Reader dapat diunduh gratis dari Adobe.com.",
  },
  {
    id: 4,
    title:
      "Saya membuka menu laporan, tetapi hanya baris yang ditampilkan, tidak ada data. Apa yang salah?",
    subtitle:
      "Bbeberapa kemungkinan yang terjadi seperti Kesalahan jaringan anda, Sistem yang padat membuat terlalu banyak request sehingga mengakibatkan lagging, dan Anda belum mengupdate sistem terbaru.",
  },
  {
    id: 5,
    title:
      "Apakah saya dapat laporan otomatis dan dapat dikirimkan ke email saya setiap sebulan sekali?",
    subtitle:
      "Tidak, Anda harus manual membuat permintaan kepada sistem yang ada.",
  },
];
...
export const kebijakan = [
  {
    id: 1,
    title: "Kebijakan Privasi Credis",
    content:
      "Kami adalah pemilik konten dan operator situs web http://www.redis.id, situs terkait dan microsites yang diakses melalui situs web tersebut (masing-masing disebut “Situs“ dan secara kolektif disebut “Situs-situs“) (“Credis.“, atau “kami“). Harap diperhatikan bahwa Credis. tidak bertanggung jawab atas situs web lain yang dikelola oleh perusahaan lain dari grup Credis. atau tautan ke situs atau konten lain di internet yang dimiliki atau dioperasikan oleh pihak ketiga. Situs atau konten terkait tidak berada di bawah kendali kami dan Credis. tidak bertanggung jawab atas kesalahan, kelalaian, penundaan, pencemaran nama baik, fitnah, kebohongan, pornografi, konten cabul, ketidakakuratan atau materi lain yang terkandung dalam konten, atau konsekuensi dari mengakses situs web terkait.",
  },
  {
    id: 2,
