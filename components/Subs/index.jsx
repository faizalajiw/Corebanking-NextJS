  ...
  return (
    <div className="bg-bluecredis flex px-10 pt-5 md:px-32">
        <div className="container flex-[160%] text-center md:text-left">
            <h1 className="font-bold text-3xl pb-1 text-gray-400">Berlangganan kepada kami</h1>
            <p className="pb-6 text-gray-400">Dapatkan berbagai promosi dan informasi lainnya</p>
            <form action="" className="flex justify-center content-center gap-3 md:relative md:justify-start md:content-start">
                ...
                <button className="px-5 py-3 md:py-2 rounded text-white bg-green-400  top-[6px] left-[158px] text-sm md:absolute md:left-[330px]">Berlangganan</button>
            </form>
        </div>
